                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-gray-600">
                        {formData.phoneNumber || "Add your contact info"}
                      </p>
                    </div>
                    ...
                    <div className="flex gap-4 mt-6">
                      ...
                      <button className="flex items-center cursor-pointer gap-2 px-6 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors duration-200">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5"
                          viewBox="0 0 20 20"
