                ...
                <div className="mt-6 sm:mt-0">
                        <button
                          ...
                          className={`px-8 py-3 rounded-xl font-semibold shadow-lg ${
                            hasApplied ? "bg-gray-500 cursor-not-allowed" : "bg-teal-700 text-white cursor-pointer"
                          }`}
                          disabled={hasApplied}
                        >
    ...
    {showprofilemodal && (
            <div className="fixed inset-0 flex items-center justify-center backdrop-blur-xs">
              <div className="bg-white p-6 rounded-lg shadow-xl max-w-xs md:max-w-md">
                ...
                <p className="text-gray-700">Please complete your profile to apply for this job</p>
